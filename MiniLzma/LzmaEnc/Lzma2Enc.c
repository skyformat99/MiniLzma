...
SRes Lzma2Encode(Byte *dest, SizeT *destLen, const Byte *src, SizeT srcLen,
	const CLzma2EncProps *props, Byte *propsEncoded, SizeT *propsSize, int writeEndMark,
	ICompressProgress *progress, ISzAllocPtr alloc, ISzAllocPtr allocBig)
{
	CLzma2Enc *p = (CLzma2Enc *)Lzma2Enc_Create(alloc, alloc);
	SRes res;
	if (!p)
		return SZ_ERROR_MEM;
	...
	if (res == SZ_OK)
	{
		Lzma2Enc_WriteProperties(p);
		res = Lzma2Enc_Encode2(p, dest, destLen, src, srcLen,
